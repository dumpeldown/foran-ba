...
\begin{figure}[H]
    ...
    \end{tikzpicture}
    \caption{Ablauf des Mapping von MITRE-Technik zu spezifischen CVE-Datum über die Kategorisierungssysteme MITRE, CAPEC, CWE und CVE.}
