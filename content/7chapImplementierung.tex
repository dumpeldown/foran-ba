...
\begin{figure}
    ...
    \begin{tikzpicture}[node distance=2cm, auto]
        ...
        \node (stop) [rectangle, draw,below of=process4] {Visualisierung des Graphens};
    ...
    \end{tikzpicture}
    \caption{Schritte zur Erstellung des Graphens}
